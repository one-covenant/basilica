...
mod tests {
    ...
    fn test_authenticated_request_all_types() {
        ...
        let sys_req = protocol::executor_control::SystemProfileRequest {
        ...
        let bench_req = protocol::executor_control::BenchmarkRequest {
        ...
        let container_req = protocol::executor_control::ContainerOpRequest {
        ...
        let health_req = protocol::executor_control::HealthCheckRequest {
