...
impl BillingServer {
    ...
    pub async fn serve(
        ...
        let buffer_size = self.config.telemetry.ingest_buffer_size;
        ...
        server_builder = server_builder
            ...
            .timeout(std::time::Duration::from_secs(
                self.config.grpc.request_timeout_seconds,
            ))
            .initial_stream_window_size(65536)
            .initial_connection_window_size(65536)
            .max_concurrent_streams(Some(self.config.grpc.max_concurrent_streams));
