...
mod tests {
    ...
    fn test_gpu_allocations_sum_to_100() {
        ...
        allocations.insert("H100".to_string(), GpuAllocation::new(30.0));
        ...
        allocations.insert("A100".to_string(), GpuAllocation::new(33.34));
        config.gpu_allocations = allocations;
        assert!(config.validate().is_ok());
        ...
        let mut allocations = HashMap::new();
        allocations.insert("H100".to_string(), GpuAllocation::new(-10.0));
        ...
        let mut allocations = HashMap::new();
        allocations.insert("H100".to_string(), GpuAllocation::with_min_count(50.0, 0));
        ...
        let mut allocations = HashMap::new();
        allocations.insert("H100".to_string(), GpuAllocation::with_min_count(25.0, 4));
...
"#;
        ...
        assert_eq!(config.get_gpu_allocation_weight("H100"), Some(25.0));
...
"#;
    ...
    fn test_edge_cases() {
        ...
        let mut allocations = HashMap::new();
        allocations.insert("H100-新".to_string(), GpuAllocation::new(50.0));
        ...
        let mut allocations = HashMap::new();
        allocations.insert("H100".to_string(), GpuAllocation::new(0.001));
    ...
    fn test_gpu_allocation_methods() {
        ...
        assert_eq!(removed.unwrap().weight, 20.0);
        assert!(!config.has_gpu_model("A100"));
        ...
        assert_eq!(models[1].0, "H100".to_string());
        assert_eq!(models[1].1.weight, 30.0);
    ...
    fn test_precision_handling() {
        ...
        allocations.insert("A100".to_string(), GpuAllocation::new(33.333334));
...
[gpu_allocations]
H100 = { weight = 8.0, min_gpu_count = 4 }
...
"#;
        ...
        let h100 = config.get_gpu_allocation("H100").unwrap();
        assert_eq!(h100.weight, 8.0);
        assert_eq!(h100.min_gpu_count, 4);
